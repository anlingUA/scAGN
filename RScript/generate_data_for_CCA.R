...
interdata_graph_generation <- function(refdf, querydf, reflabel,  querylabel, folder_to_save)
{
    fprintf("Graph data will be saved in [%s] folder\n", folder_to_save)
    ## Shuffle
    ...
    folder = folder_to_save #"../data/GSE108989"
    source('data_preprocess_utility.R')
    save_processed_data(mycount.list,mylabel.list, folder)
    print("Done!")
}
intradata_graph_generation <- function(data, labels, folder_to_save)
{
    fprintf("Graph data will be saved in [%s] folder\n", folder_to_save)
...
# 'GSE85241_GSE81076' : interdataset predictions: CEL-seq2 -> CEL-seq
# 'GSE81076_GSE85241' : interdataset predictions: CEL-seq -> CEL-seq2
# 'GSE83139_GSE84133' : interdataset predictions: scRNAseq -> scRNAseq (pancreas)
# 'GSE84133_GSE83139' : interdataset predictions: scRNAseq -> scRNAseq (pancreas)
...
if(dataset == "GSE165092") {
    ...
    intradata_graph_generation(data, labels, folder ="../data/GSE165092")
    ...
    print(head(labels))
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(data, labels, folder ="../data/GSE108989")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(tdataGSE72056, labels, folder ="../data/GSE72056")
    ...
    rownames(labels) <- rows
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(tdataGSE85241, labels, folder ="../data/GSE85241")
    ...
    print(head(labels))
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(data, labels, folder ="../data/GSE98638")
    ...
    print(head(labels))
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(data, labels, folder ="../data/GSE99254")
    ...
    rownames(labels) <- rows
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(tdataGSE118389, labels, folder ="../data/GSE118389")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(dataGSE83139, labels, folder_to_save ="../data/GSE83139")
    ...
    interdata_graph_generation(dataGSE85241, dataGSE81076, labelsGSE85241,  labelsGSE81076, folder_to_save ="../data/GSE85241_GSE81076")
    ...
    dataGSE85241 <- dataGSE85241[,common_genes]
    dataGSE81076 <- dataGSE81076[,common_genes]
    interdata_graph_generation(dataGSE81076, dataGSE85241, labelsGSE81076, labelsGSE85241, folder_to_save ="../data/GSE81076_GSE85241")
    ...
    interdata_graph_generation(dataGSE83139, dataGSE84133, labelsGSE83139, labelsGSE84133, folder_to_save ="../data/GSE83139_GSE84133")
    ...
    dataGSE83139 <- dataGSE83139[,common_genes]
    dataGSE84133 <- dataGSE84133[,common_genes]
    interdata_graph_generation(dataGSE84133, dataGSE83139, labelsGSE84133, labelsGSE83139, folder_to_save ="../data/GSE84133_GSE83139")
    ...
    interdata_graph_generation(dataGSE84133_human, dataGSE84133_mouse, labelsGSE84133_human, labelsGSE84133_mouse, folder_to_save ="../data/GSE84133_human_mouse")
    ...
    fprintf("Shape of dataset is [%d x %d]\n", dim(dataGSE84133_mouse)[1],dim(dataGSE84133_mouse)[2] )
    fprintf("Shape of labels df is [%d x %d]\n", dim(labelsGSE84133_mouse)[1],dim(labelsGSE84133_mouse)[2] )
    interdata_graph_generation(dataGSE84133_mouse, dataGSE84133_human, labelsGSE84133_mouse, labelsGSE84133_human, folder_to_save ="../data/GSE84133_mouse_human")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(dataGSE124952, labels, folder_to_save ="../data/GSE124952")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    intradata_graph_generation(dataGSE103892, labels, folder_to_save ="../data/GSE103892")
} else if(dataset == 'xin') {
    ...
    intradata_graph_generation(data, labels, folder ="../data/Xin")
} else if(dataset == 'TM') {
    main_directory <- sprintf("%s/%s", folder, 'ADClust_datasets')
    fprintf("%s\n",main_directory)
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/TM")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/Tasic")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/Segerstolpe")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/Romanov")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/PBMC_68k")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/Mouse_retina")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder ="../data/Klein")
    ...
    fprintf("Shape of labels df is [%d x %d]\n", dim(labels)[1],dim(labels)[2] )
    stopifnot(identical(rownames(data), rownames(labels)))
    intradata_graph_generation(data, labels, folder =sprintf("../data/%s", dataset))   
